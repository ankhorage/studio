...
| Area                      | Decision                                                                                                                                                                                                                                          |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `package.json/main`       | Use direct `expo-router/entry`; no wrapper entry file is generated.                                                                                                                                                                               |
| Router config plugin      | Use the default `expo-router` config plugin. Runtime-plan plugins and an optional splash plugin remain capability-driven additions.                                                                                                               |
