...
- e1e12f3: Update Ankhorage dependencies: `@ankhorage/utility`, `@ankhorage/zora-game`.
...
- e6fd51f: Route DataSchema-backed binding operation literals through the shared neutral Authoring Engine while preserving binding-specific operation, response-path, compatibility, event-payload, and action-target workflows.
...
- 4db1cc5: Update Ankhorage dependencies: `@ankhorage/zora-game`, `@ankhorage/zora-tabletop`.

## 5.5.3

### Patch Changes

- 44277d3: Update Ankhorage dependencies: `@ankhorage/zora`.

## 5.5.2

### Patch Changes

- 5f8733d: Update Ankhorage dependencies: `@ankhorage/zora-game`.
...
- 4c7e90e: Update Ankhorage dependencies: `@ankhorage/zora-game`.
...
- 8b34520: Update Ankhorage dependencies: `@ankhorage/navigator`, `@ankhorage/runtime`, `@ankhorage/zora-game`, `@ankhorage/zora-tabletop`, `@ankhorage/zora`.
...
- dab3bd0: Update Ankhorage dependencies: `@ankhorage/templates`, `@ankhorage/zora-game`, `@ankhorage/zora-tabletop`, `@ankhorage/zora`.
...
- 6af501c: Update Ankhorage dependencies: `@ankhorage/zora-game`, `@ankhorage/zora`.

## 3.2.1

### Patch Changes

- 6e608fb: Update Ankhorage dependencies: `@ankhorage/zora-game`, `@ankhorage/zora-tabletop`, `@ankhorage/zora`.
...
- e4ed56d: Update Ankhorage dependencies: `@ankhorage/contracts`, `@ankhorage/data-sources`, `@ankhorage/expo-runtime`, `@ankhorage/minikube`, `@ankhorage/repository`, `@ankhorage/runtime`, `@ankhorage/supabase-auth`, `@ankhorage/supabase-storage`, `@ankhorage/zora-game`, `@ankhorage/zora-tabletop`, `@ankhorage/zora`.
...
- e1f5529: Update Ankhorage dependencies: `@ankhorage/zora-game`, `@ankhorage/zora-tabletop`, `@ankhorage/zora`.
...
- f92c7f5: Update Ankhorage dependencies: `@ankhorage/contracts`, `@ankhorage/data-sources`, `@ankhorage/expo-runtime`, `@ankhorage/minikube`, `@ankhorage/repository`, `@ankhorage/runtime`, `@ankhorage/supabase-auth`, `@ankhorage/supabase-storage`, `@ankhorage/supabase-vault`, `@ankhorage/zora-game`, `@ankhorage/zora-tabletop`, `@ankhorage/zora`.

## 3.1.5

### Patch Changes

- 34455ef: Update Ankhorage dependencies: `@ankhorage/expo-runtime`, `@ankhorage/minikube`, `@ankhorage/repository`, `@ankhorage/runtime`, `@ankhorage/supabase-auth`, `@ankhorage/zora-game`, `@ankhorage/zora-tabletop`, `@ankhorage/zora`.
...
- 79c9185: Update Ankhorage dependencies: `@ankhorage/infra`, `@ankhorage/orchestrator-module-expo-google-fonts`, `@ankhorage/orchestrator-module-expo-localization`, `@ankhorage/repository`, `@ankhorage/supabase-auth`, `@ankhorage/supabase-storage`, `@ankhorage/supabase-vault`, `@ankhorage/utility`, `@ankhorage/zora-tabletop`, `@ankhorage/zora`.
...
- 019ef5a: Restore generated-app and standalone registry acceptance by emitting formatter-stable Auth screen imports, validating owner ranges from the installed Studio dependency graph, aligning the Expo 57.0.23 consumer contract, allowing Metro to crawl nested package-owned dependencies instead of excluding them with a custom node_modules blocklist, requiring the released Infra 5.1.5 destroy semantics so deleting a never-provisioned project remains idempotent without provider resolution, and collapsing duplicate host-facing status rows while preserving the full scoped APM evidence for planning.
...
- dfcc274: Migrate Studio project infrastructure to the released Contracts 19 environment model and Infra 5 provider-neutral typed lifecycle, outputs, status, and destroy semantics. Studio now composes its bundled local, Minikube, Supabase, and Supabase Vault adapters through the public Infra resolver boundary.
...
- 93d9afa: Use the released Navigator SVG source support and updated SharkPrey template for project generation.
...
- b758e68: Preserve packaged template-media filenames when generating bundled project assets so Expo web export and Infra Up can resolve them.
...
- fa681f4: Fix the managed `ankhorage-project-structure` skill so it no longer references the obsolete `ankhorage-package-structure` authority and keep the synced skill output self-contained.
...
- 332445b: Generate lint-clean Expo auth scaffolds against the released Studio 2.0.2 baseline with an independently reachable correlated callback route, and permanently verify served static auth, OAuth mismatch/replay, and capability hydration through released owner APIs.
