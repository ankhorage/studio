...
const registrySource = await Bun.file(path.join(import.meta.dir, 'moduleAdminViewRegistry.ts')).text();
...
test('registers package-owned views without importing module operation semantics', () => {
  expect(registrySource).toContain(
    '@ankhorage/orchestrator-module-expo-localization/admin-view',
  );
