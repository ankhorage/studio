...
import { ZORA_PLUGIN_METADATA as ZORA_GAME_PLUGIN_METADATA } from '@ankhorage/zora-game/metadata';
...
export const STUDIO_ZORA_EXTENSION_SOURCES = [
  ...
  { descriptorExportName: 'ZORA_GAME_PLUGIN', metadata: ZORA_GAME_PLUGIN_METADATA },
